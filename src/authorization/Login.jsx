        ...
        <div className="w-1/2 flex justify-center items-center">
          <div className="border rounded-lg p-8 mr-56" style={{ borderColor: '#d3d3d3' }}>
            <form className="w-[300px]" onSubmit={handleSubmit}>
              <div className="mb-4">
                <label htmlFor="email" className="block text-sm text-gray-700 font-medium" required>Email</label>
              ...
              <div className="mb-4 relative">
                <label htmlFor="password" className="block text-sm text-gray-700 font-medium" required>Password</label>
                <input type={passwordVisible ? "text" : "password"} id="password" className="mt-1 block w-full px-3 py-2 border border-[#004AAD] rounded-md focus:outline-none focus:ring-[#004AAD] focus:border-[#004AAD]" />
              ...
              <div className="mb-4">
                <Link to="/forgetpassword" className="text-sm text-[#004AAD] hover:underline font-medium">Forgot Password?</Link>
              </div>
              <div>
