            ...
            <div className="w-full max-w-4xl mx-auto p-8 mt-8 bg-white rounded-lg shadow-lg">
                ...
                <div className="flex items-center border-b border-black-200 pb-5 mb-5">
                    ...
                    <div>
                        ...
                        <div className="flex items-center text-black-500 mt-2">
                ...
                <div className="border-b border-black-200 pb-5 mb-5">
                    ...
                    <div className="flex justify-between items-center text-black-700 mb-2">
                        <span>Price: $1 x 15 minutes</span>
                        <span>$15.00</span>
                    </div>
                    <div className="flex justify-between items-center text-black-700 mb-2">
                ...
                <div className="mt-5">
                    ...
                    <div 
                        className={`flex items-center p-4 bg-black-100 rounded-lg cursor-pointer transition-all duration-200 ${
                            selectedPayment === 'phonepe' ? 'border-2 border-blue-500' : 'border border-black-300'
                        } hover:shadow-md`}
