        ...
        <>
            <div className="w-full max-w-4xl mx-auto p-8 mt-8 bg-white rounded-lg shadow-lg">
                ...
                <div className="flex items-center border-b border-black-200 pb-5 mb-5">
                    <img src={(doctor?.doctor?.profileUrl) ? doctor.doctor.profileUrl : "https://images.pexels.com/photos/8376277/pexels-photo-8376277.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"}
                        alt="Shikara Hotel"
                        className="w-32 h-32 rounded-lg mr-6 object-cover shadow-md"
                    />
                    <div>
                        <h3 className="text-xl font-semibold text-black-700">{(doctor?.doctor?.name) ? doctor.doctor.name : ""}, {(doctor?.service?.clinicId?.
                            city

                        ) ? doctor.service.clinicId.
                            city
                        ...
                        <a href='#' className="flex items-center text-black-500 mt-2 hover:text-info" title='View Clinic In Map'>
                            ...
                            <span onClick={() => openGoogleMaps(doctor?.service?.clinicId?.
                                lat
                                , doctor?.service?.clinicId?.
                                    long
                            )}>
                ...
                <div className="border-b border-black-200 pb-5 mb-5">
                    ...
                    <div className="flex justify-between items-center text-black-700 mb-2">
                        ...
                        <span>   {(doctor?.service?.treatmentName

                        ) ? doctor.service.treatmentName
                    ...
                    <div className="flex justify-between items-center text-black-700 mb-2">
                        <span>
                            Specialty
                            : </span>
                        <span> {(doctor?.service?.specialty

                        ) ? doctor.service.specialty

                            : ""}</span>
                    </div>
                    <div className="flex justify-between items-center text-black-700 mb-2">
                        <span>Clinic Address: </span>
                        <span>  {(doctor?.service?.clinicId?.
                            address
                ...
                <div className="border-b border-black-200 pb-5 mb-5">
                    ...
                    <div className="flex justify-between items-center text-black-700 mb-2">
                        <span>(Treatment Fees: {(doctor?.service?.duration
