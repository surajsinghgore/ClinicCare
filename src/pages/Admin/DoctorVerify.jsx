...
const DoctorVerify = () => {
    ...
    return (
        <>
            ...
            <div className="relative w-[90%] m-auto mt-10 rounded-lg shadow-lg">

                <div className="w-full p-12 rounded-lg shadow-md">
                    <div className="pb-5 flex items-center gap-3 text-[#116AEF] mb-10 border-b border-gray-400">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        ...
                        <div className="col-span-2">
                            <h3 className="text-xl underline font-medium text-black-700 mt-4">Uploaded Files:</h3>
                            <div className="mt-2">
                                <label className="block text-lg font-medium text-black-700">Self Image:</label>
                                <img src={doctorData.files.selfImage} alt="Self" className="mt-1 w-80" />

                                <label className="block text-lg font-medium text-black-700">Degree Image:</label>
                                <img src={doctorData.files.degreeImage} alt="Degree" className="mt-1 w-80" />

                                <label className="block text-lg font-medium text-black-700">License Image:</label>
                                <img src={doctorData.files.licenseImage} alt="License" className="mt-1 w-80" />

                                <label className="block text-lg font-medium text-black-700">Signature Image:</label>
                                <img src={doctorData.files.signImage} alt="Signature" className="mt-1 w-80" />
                            </div>
                        </div>
                    </div>
                </div>
