      ...
      <div className="relative docDiv w-[85%] h-full m-auto mt-10 rounded-lg">
        ...
        <div className="flex p-6">
          ...
          <div className="flex flex-col ml-14">
            <div className="flex items-center mb-2">
              <label className="text-black-400">
                Date of Birth <span className="text-danger text-lg">*</span>
              </label>
            </div>
            <div className="flex items-center relative">
        ...
        <button className="ml-auto bg-blue-500 hover:bg-blue-700 duration-200 text-white m-8 shadow-lg font-bold py-2 px-3 rounded-md absolute bottom-0 right-0">Submit</button>
      </div>
    </>
  );
};
