...
const DoctorVerification = () => {
  return (
    <>
     ...
     <div className='relative docDiv w-[90%] h-full m-auto mt-10 rounded-lg'>
            ...
            <div className='flex items-center relative'>
              <div className='flex gap-4'>
                <label className='flex items-center gap-2'>
                  <input type="radio" name="gender" value="male" className='form-radio text-base' required />
                  <span className='text-gray-700'>Male</span>
                </label>
                <label className='flex items-center gap-2'>
                  <input type="radio" name="gender" value="female" className='form-radio text-base' required />
