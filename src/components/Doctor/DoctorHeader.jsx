...
const DoctorHeader = () => { 
  ...
  return (
    <div className="h-[80px] bg-gradient-to-r from-blue-400 to-blue-700 text-white py-4 px-10 flex justify-between items-center">
      ...
      <div className="flex items-center">
        <div className="relative w-80">
          ...
          <input type="search" id="default-search" className="block w-full p-4 ps-10 text-sm text-black-900 border border-black-300 rounded-lg bg-black-50 focus:ring-blue-500 focus:border-blue-500  dark:border-black-600 dark:placeholder-black-400 dark:text-black-900 dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search Patient, Appoint..." required />
